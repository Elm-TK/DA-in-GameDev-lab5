...
Для расчёта параметров, которые бы приближали игру к состоянию сбалансированности, нужно изучать, сравнивать и расчитывать огромное количество параметров. В данной ситуации могут очень пригодится системы машинного обучения, которые на основании определенных начальных данных будут пытаться уравнивать возможности / цены / сложность и другие параметры игры.
